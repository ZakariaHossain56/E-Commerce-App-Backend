...
router.post('/', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const newSubCategory = await subCategory.save();    //The result (newSubCategory) is the saved document with a unique _id and other metadata like createdAt and updatedAt if timestamps are enabled.
